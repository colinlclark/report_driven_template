...
fo_md = "report_for_my_project.md"
fo_tex = "report_for_my_project.tex"
...
plt.ylabel("Always label your y-axis: cos(x)")
...
fo_table = "data/My_Table.csv"
df_table.to_csv(fo_table)
